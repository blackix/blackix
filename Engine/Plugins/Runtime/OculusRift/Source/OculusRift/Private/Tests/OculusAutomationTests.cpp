...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FOculusAutomationTest_Screenshots, "Oculus.Screenshots", EAutomationTestFlags::ATF_Editor | EAutomationTestFlags::ATF_Game | EAutomationTestFlags::ATF_NonNullRHI)
