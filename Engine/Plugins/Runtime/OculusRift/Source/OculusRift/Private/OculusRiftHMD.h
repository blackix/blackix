...
public:
	...
	public:
		...
		// @return a texture that represents a D3D11Texture2DSet
		virtual FTexture2DRHIRef AllocateRenderTargetTexture(int32 TexWidth, int32 TexHeight, EPixelFormat Format) override;
