...
FTextureSetProxyPtr FD3D11CustomPresent::CreateTextureSet_RenderThread(uint32 InSizeX, uint32 InSizeY, EPixelFormat InFormat, uint32 InNumMips, uint32 InNumSamples, uint32 InArraySize, const TArray<ovrpTextureHandle>& InTextures)
{
	CheckInRenderThread();
