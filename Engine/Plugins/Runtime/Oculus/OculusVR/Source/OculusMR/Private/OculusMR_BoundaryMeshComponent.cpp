...
public:
		...
		, BoundaryMeshComponent(Component)
	{
		...
		{
			Geometry = UOculusFunctionLibrary::GetGuardianPoints(EBoundaryType::Boundary_Outer);
		}
		else
		{
			Geometry = UOculusFunctionLibrary::GetGuardianPoints(EBoundaryType::Boundary_PlayArea);
		}
