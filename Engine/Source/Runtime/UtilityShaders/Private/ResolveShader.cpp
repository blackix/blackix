...
IMPLEMENT_SHADER_TYPE(, FResolveDepth2xPS, TEXT("ResolvePixelShader"), TEXT("MainDepthMSAA"), SF_Pixel);
IMPLEMENT_SHADER_TYPE(, FResolveDepth4xPS, TEXT("ResolvePixelShader"), TEXT("MainDepthMSAA"), SF_Pixel);
