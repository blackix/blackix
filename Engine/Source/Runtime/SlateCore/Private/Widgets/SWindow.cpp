...
void SWindow::ConstructWindowInternals()
{
    ...
    // create window
    if (Type != EWindowType::ToolTip && Type != EWindowType::CursorDecorator && Type != EWindowType::CastingWindow && !bIsPopupWindow && !bHasOSWindowBorder)
	{
...
{
	return Type != EWindowType::CursorDecorator && Type != EWindowType::ToolTip && Type != EWindowType::CastingWindow;
}
...
{
	return Type != EWindowType::ToolTip && Type != EWindowType::CursorDecorator && Type != EWindowType::CastingWindow;
}
