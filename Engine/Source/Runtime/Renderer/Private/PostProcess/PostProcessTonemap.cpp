...
#define VARIATION1(A) typedef FPostProcessTonemapPS<A> FPostProcessTonemapPS##A; \
	...
	VARIATION1(9)  VARIATION1(10) VARIATION1(11) VARIATION1(12) VARIATION1(13) VARIATION1(14) VARIATION1(15) VARIATION1(16) VARIATION1(17)
...
void FRCPassPostProcessTonemap::Process(FRenderingCompositePassContext& Context)
{
	...
	case 15: SetShaderTempl<15>(Context, bDoEyeAdaptation); break;
	case 16: SetShaderTempl<16>(Context, bDoEyeAdaptation); break;
	case 17: SetShaderTempl<17>(Context, bDoEyeAdaptation); break;
	default:
		check(0);
	}
