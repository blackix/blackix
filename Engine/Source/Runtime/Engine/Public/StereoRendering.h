...
public:
	 ...
	 */
	virtual void UpdateViewport(const FViewport& Viewport, const FRHIViewport* ViewportRHI = nullptr) {}
	/**
	...
	virtual void RenderTexture_RenderThread(FTexture2DRHIParamRef BackBuffer, FTexture2DRHIParamRef SrcTexture) const {}
