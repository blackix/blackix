 ...
 */
UCLASS(ClassGroup = "Collision", Blueprintable, editinlinenew, hidecategories = (Object, LOD, Lighting, TextureStreaming), meta = (DisplayName = "Capsule Collision", BlueprintSpawnableComponent))
