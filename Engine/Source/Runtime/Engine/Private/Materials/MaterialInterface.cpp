...
bool UMaterialInterface::IsAlphaToCoverage(bool bIsInGameThread) const
{
	return false;
}

bool UMaterialInterface::IsFullyRough(bool bIsInGameThread) const
{
	return false;
}

bool UMaterialInterface::IsCheapShading(bool bIsInGameThread) const
{
	return false;
}
