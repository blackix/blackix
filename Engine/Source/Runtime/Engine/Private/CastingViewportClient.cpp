...
{
    // Gather the standard view extensions but skip the extensions from GEngine->HMDDevice
...
void UCastingViewportClient::Draw(FViewport* InViewport, FCanvas* SceneCanvas)
{
	...
	EngineShowFlagOverride(ESFIM_Game, (EViewModeIndex)ViewModeIndex, ViewFamily.EngineShowFlags, NAME_None, false/*SplitScreenConfig != ESplitScreenType::None*/);
